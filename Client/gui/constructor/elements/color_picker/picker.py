...
class ColorPicker(ft.Row):
    def __init__(self, base_color="#000000", map_width=COLOR_MATRIX_WIDTH):
    ...
    def update_circle_position(self):
        ...
        self.thumb.left = hsv_color[1] * self.color_map.width  # s * map_width
    ...
    def generate_selected_color_view(self):
        ...
        self.selected_color_view = ft.Column(
            spacing=20,
            controls=[
                ft.Text(value='avatar color:', color=ft.colors.GREY, size=15, font_family='inter-regular'),
                ft.Row(
    ...
    def update_selected_color_view_values(self):
        rgb = hex2rgb(self.color)
        self.selected_color_view.controls[1].controls[
            0
